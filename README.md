# Munters-Login-Page
Login page web application using Angular and AngularJS for different areas of the project as requested by employer, with extra constantly updating weather forecast page at the end of project using websocket implementation(Had a little help).<br>
